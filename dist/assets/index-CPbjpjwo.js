...
var We = x.createContext(!1),
  Ge = x.createContext({ isTransitioning: !1 });
Ge.displayName = `ViewTransition`;
var Ke = x.createContext(new Map());
...
var Xe = x.createContext({ outlet: null, matches: [], isDataRoute: !1 });
...
function rt(e, { relative: t } = {}) {
  w(it(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = x.useContext(Je),
...
function at() {
  return (
    ...
    x.useContext(Ye).location
  );
}
var ot = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function st(e) {
  x.useContext(Je).static || x.useLayoutEffect(e);
}
function ct() {
  let { isDataRoute: e } = x.useContext(Xe);
  return e ? kt() : lt();
}
function lt() {
  w(
  ...
  let e = x.useContext(He),
    { basename: t, navigator: n } = x.useContext(Je),
    { matches: r } = x.useContext(Xe),
    { pathname: i } = at(),
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        if ((T(o.current, ot), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function ut() {
  let { matches: e } = x.useContext(Xe),
    t = e[e.length - 1];
  return t ? t.params : {};
}
function dt(e, { relative: t } = {}) {
  let { matches: n } = x.useContext(Xe),
    { pathname: r } = at(),
...
function pt(e, t, n) {
  ...
  let { navigator: r } = x.useContext(Je),
    { matches: i } = x.useContext(Xe),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
function vt({ children: e, error: t }) {
  let { basename: n } = x.useContext(Je);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function yt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    x.createElement(Xe.Provider, { value: e }, n)
  );
}
function bt(e, t = [], n) {
  let r = n?.state;
  ...
  return (
    ...
    h == null
      ...
      : x.createElement(
          Je.Provider,
          { value: c },
          x.createElement(Ye.Provider, { children: t, value: h }),
        )
  );
}
function Ft({ children: e, location: t }) {
  return ft(It(e), t);
}
x.Component;
function It(e, t = []) {
  ...
  return (
    x.Children.forEach(e, (e, r) => {
      ...
      if (e.type === x.Fragment) {
        n.push.apply(n, It(e.props.children, i));
        return;
      }
      (w(
        e.type === Nt,
      ...
      (e.props.children && (a.children = It(e.props.children, i)), n.push(a));
    }),
    n
  );
}
...
function Yt(e, t) {
  ...
  if (Vt(e)) {
    ...
    ((r = o ? Ce(o, t) : null),
      ...
      (i = Jt(e.getAttribute(`enctype`)) || Rt),
      (a = new FormData(e)));
  } else if (Bt(e) || (Ht(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
...
function sn(e, t, { includeHydrateFallback: n } = {}) {
  return cn(
    e
      .map((e) => {
        let r = t.routes[e.route.id];
...
function un(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((e, i) => {
    if (t && !nn(i) && i.as === `script` && i.href && r.has(i.href)) return e;
...
var pn = x.createContext(void 0);
pn.displayName = `FrameworkContext`;
function mn() {
  let e = x.useContext(pn);
  return (
    $t(e, `You must render this element inside a <HydratedRouter> element`),
    e
  );
}
function hn(e, t) {
  let n = x.useContext(pn),
    [r, i] = x.useState(!1),
    [a, o] = x.useState(!1),
    {
      onFocus: s,
...
function _n({ page: e, ...t }) {
  let { router: n } = dn(),
    r = x.useMemo(() => se(n.routes, e, n.basename), [n.routes, e, n.basename]);
  return r ? x.createElement(yn, { page: e, matches: r, ...t }) : null;
}
function vn(e) {
...
function yn({ page: e, matches: t, ...n }) {
  let r = at(),
    { future: i, manifest: a, routeModules: o } = mn(),
    { basename: s } = dn(),
    { loaderData: c, matches: l } = fn(),
    u = x.useMemo(() => on(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = x.useMemo(() => on(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = x.useMemo(() => {
      ...
      if (
        ...
        return [];
      let d = en(e, s, i.unstable_trailingSlashAwareDataRequests, `data`);
      return (
        l &&
          n.size > 0 &&
          d.searchParams.set(
...
var xn =
  ...
  window.document.createElement !== void 0;
try {
  xn && (window.__reactRouterVersion = `7.13.2`);
} catch {}
function Sn({
  basename: e,
  children: t,
...
Cn.displayName = `unstable_HistoryRouter`;
var wn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Tn = x.forwardRef(function (
    ...
    let {
      ...
      v = typeof l == `string` && wn.test(l),
      y = ze(l, h);
    l = y.to;
    let b = rt(l, { relative: r }),
      ee = at(),
      S = null;
    if (o) {
    ...
    return C && !v
      ? x.createElement(x.Fragment, null, re, x.createElement(_n, { page: b }))
      : re;
  });
Tn.displayName = `Link`;
var En = x.forwardRef(function (
  ...
  let u = dt(a, { relative: c.relative }),
    d = at(),
    f = x.useContext(Ue),
    { navigator: p, basename: m } = x.useContext(Je),
    h = f != null && Hn(u) && o === !0,
...
var Dn = x.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = x.useContext(Je),
      g = Fn(),
      _ = In(s, { relative: l }),
      v = o.toLowerCase() === `get` ? `get` : `post`,
      y = typeof s == `string` && wn.test(s);
...
Dn.displayName = `Form`;
function On({ getKey: e, storageKey: t, ...n }) {
  let r = x.useContext(pn),
    { basename: i } = x.useContext(Je),
    a = at(),
    o = A();
  Bn({ getKey: e, storageKey: t });
  let s = x.useMemo(() => {
    if (!r || !e) return null;
    let t = zn(a, o, i, e);
  ...
  return x.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${Qt(JSON.stringify(t || Ln))}, ${Qt(JSON.stringify(s))})`,
    },
  });
}
On.displayName = `ScrollRestoration`;
function kn(e) {
  return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function An(e) {
...
function Bn({ getKey: e, storageKey: t } = {}) {
  let { router: n } = An(`useScrollRestoration`),
    { restoreScrollPosition: r, preventScrollReset: i } =
      jn(`useScrollRestoration`),
    { basename: a } = x.useContext(Je),
    o = at(),
    s = A(),
    c = Dt();
  (x.useEffect(
    ...
    Vn(
      x.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || Ln, JSON.stringify(Rn));
        } catch (e) {
          T(
            !1,
...
var Un = o((e) => {
  ...
  Gn = g(),
  j = Wn(),
  Kn = (0, x.createContext)();
function qn() {
  return (0, x.useContext)(Kn);
}
var Jn = `fakestore_cart`;
function Yn({ children: e }) {
  ...
  function r(e) {
    n((t) => {
      ...
      if (n !== -1) {
        let e = [...t];
        return ((e[n] = { ...e[n], quantity: e[n].quantity + 1 }), e);
      }
      return [...t, { ...e, quantity: 1 }];
    });
  }
  function i(e) {
  ...
  function a(e, t) {
    n((n) =>
      n.map((n) => (n.id === e ? { ...n, quantity: Math.max(1, t) } : n)),
    );
  }
  function o() {
    n([]);
  }
  return (0, j.jsx)(Kn.Provider, {
    value: {
      cartItems: t,
      addToCart: r,
      removeFromCart: i,
...
var Xn = {
  ...
  Zn = x.createContext && x.createContext(Xn),
  Qn = [`attr`, `size`, `title`];
function $n(e, t) {
  if (e == null) return {};
  var n,
...
function sr(e) {
  return (
    e &&
    e.map((e, t) => x.createElement(e.tag, rr({ key: t }, e.attr), sr(e.child)))
  );
}
function cr(e) {
  return (t) =>
    x.createElement(lr, tr({ attr: rr({}, e.attr) }, t), sr(e.child));
}
function lr(e) {
  var t = (t) => {
    ...
    return (
      ...
      x.createElement(
        ...
        tr(
          ...
          {
            className: s,
            style: rr(rr({ color: e.color || t.color }, t.style), e.style),
            height: o,
            width: o,
  ...
  return Zn === void 0
    ? t(Xn)
    : x.createElement(Zn.Consumer, null, (e) => t(e));
}
function ur(e) {
  return cr({
    tag: `svg`,
        ...
        children: [
          ...
          (0, j.jsxs)(`aside`, {
            ...
            children: [
              ...
              (0, j.jsx)(`h2`, { children: `Your Cart` }),
              n.length === 0
                ? (0, j.jsx)(`p`, { children: `Your cart is empty.` })
                : (0, j.jsxs)(j.Fragment, {
                    children: [
                      (0, j.jsx)(`ul`, {
                        children: n.map((e) =>
                                ...
                                children: [
                                  ...
                                  (0, j.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, j.jsx)(ur, {
                                        onClick: () =>
                                          i(e.id, Math.max(1, e.quantity - 1)),
                                      }),
                                      (0, j.jsx)(`span`, {
                                        children: e.quantity,
                                      }),
                                      (0, j.jsx)(mr, {
                                        onClick: () => i(e.id, e.quantity + 1),
                                      }),
                                    ],
                                  }),
                                  (0, j.jsxs)(`div`, {
...
function _r() {
  let [e, t] = (0, x.useState)(!1),
    { cartItems: n } = qn(),
    r = n.reduce((e, t) => e + t.quantity, 0);
  return (0, j.jsxs)(`nav`, {
    children: [
      (0, j.jsxs)(`div`, {
        className: `navigation`,
        children: [
          (0, j.jsx)(Tn, { to: `/`, className: `logo`, children: `FakeStore` }),
          (0, j.jsxs)(`button`, {
            className: `cart-btn`,
            onClick: () => t(!0),
            children: [
              (0, j.jsx)(gr, { className: `cart-btn__icon` }),
              r > 0 &&
                (0, j.jsx)(`span`, {
                  className: `cart-btn__count`,
                  children: r,
                }),
            ],
          }),
      ...
      e && (0, j.jsx)(hr, { open: e, onClose: () => t(!1) }),
    ],
  });
}
function vr(e) {
...
var br = `https://fakestoreapi.com`,
  xr = `http://localhost:3001`;
...
function Cr(e) {
  return Sr(`${br}/products/${e}`);
}
function wr() {
  return Sr(`${br}/products`);
}
function Tr(e) {
  return Sr(`${xr}/products/${e}`);
}
function Er() {
  return Sr(`${xr}/products`);
}
function Dr(e) {
  return Sr(`${xr}/products`, {
    method: `POST`,
...
async function Or(e) {
  let t = await Sr(`${xr}/productRatings?productId=${e}`);
  return t && t.length > 0 ? t[0].rating : null;
}
async function kr(e, t) {
  let n = await Sr(`${xr}/productRatings?productId=${e}`);
  return n && n.length > 0
    ? Sr(`${xr}/productRatings/${n[0].id}`, {
        method: `PATCH`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify({ rating: t }),
      })
    : Sr(`${xr}/productRatings`, {
        method: `POST`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify({ productId: e, rating: t }),
      });
}
function Ar(e) {
  return cr({
...
var Mr = ({ value: e = 0, onChange: t, readOnly: n = !1 }) =>
  (0, j.jsx)(`span`, {
    children: [1, 2, 3, 4, 5].map((r) =>
      (0, j.jsx)(
        `span`,
        {
          ...
          style: {
            color: r <= e ? `hsl(234, 72%, 56%)` : ``,
            cursor: n ? `default` : `pointer`,
          },
          onClick: n ? void 0 : () => t(r),
          onMouseOut: n
            ? void 0
            : (t) =>
                (t.currentTarget.style.color =
                  r <= e ? `hsl(234, 72%, 56%)` : ``),
          role: n ? void 0 : `button`,
          tabIndex: n ? -1 : 0,
          children: r <= e ? (0, j.jsx)(Ar, {}) : (0, j.jsx)(jr, {}),
        },
        r,
      ),
    ),
...
function Fr() {
  ...
  ((0, x.useEffect)(() => {
    ...
    (0, x.useEffect)(() => {
      let e = new URLSearchParams(o.search).get(`category`);
      e && a(e);
    }, [o.search]));
  let s = Array.from(new Set(e.map((e) => e.category))),
    c = i === `all` ? e : e.filter((e) => e.category === i);
  return (0, j.jsxs)(`section`, {
    ...
    children: [
      (0, j.jsxs)(`div`, {
        className: `page-hero`,
        children: [
          (0, j.jsx)(`h3`, { children: `Welcome to FakeStore` }),
          (0, j.jsx)(`h1`, { children: `Discover Amazing Products Today` }),
          (0, j.jsx)(`p`, {
            children: `Browse our curated collection of products across electronics, fashion, and more — all at great prices.`,
          }),
          (0, j.jsx)(`div`, { className: `circle-big` }),
          (0, j.jsx)(`div`, { className: `circle-small` }),
        ],
      }),
      n &&
        (0, j.jsxs)(`p`, {
          className: `product-loading-p`,
          children: [
            (0, j.jsx)(Nr, { className: `product-loading-p__icon`, size: 100 }),
            ` Loading products...`,
          ],
        }),
      !n &&
        ...
        (0, j.jsxs)(j.Fragment, {
          children: [
            (0, j.jsxs)(Tn, {
              ...
              children: [(0, j.jsx)(Pr, { size: 25 }), ` Add New Product`],
            }),
            (0, j.jsx)(`div`, {
              ...
              children: (0, j.jsxs)(`select`, {
                ...
                children: [
                  (0, j.jsx)(`option`, { value: `all`, children: `All` }),
                  s.map((e) =>
              ...
              children: c.map((e) =>
                (0, j.jsxs)(
                  `div`,
                  {
                    ...
                    children: [
                      (0, j.jsx)(`img`, { src: e.image, alt: e.title }),
                      (0, j.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, j.jsxs)(`p`, {
                            ...
                            children: [
                              (0, j.jsx)(`span`, {
                                className: `stars`,
                                "aria-label": `Rating: ${e.rating?.rate} out of 5`,
                                children: (0, j.jsx)(Mr, {
                                  value: e.rating?.rate,
                                  readOnly: !0,
                                }),
                              ...
                              (0, j.jsxs)(`span`, {
                                ...
                                children: [`(`, e.rating?.count, ` reviews)`],
                              }),
                            ],
                          }),
                          (0, j.jsxs)(`div`, {
...
var Ir = `/assets/404-Dn6HPTkP.png`;
function Lr() {
  let { id: e } = ut(),
    ...
    r
      ? (0, j.jsx)(`div`, {
          ...
          children: (0, j.jsxs)(`p`, {
            ...
            children: [
              (0, j.jsx)(Nr, {
                className: `product-loading-p__icon`,
                size: 100,
              }),
              ` Loading products...`,
            ],
            ...
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`span`, {
                    className: `product-category-span`,
                    children: (0, j.jsx)(Tn, {
                      to: `/?category=${encodeURIComponent(t.category)}`,
                      className: `link`,
                      children: t.category,
                    }),
                  }),
                  (0, j.jsx)(`span`, { children: `›` }),
                  (0, j.jsx)(`span`, { children: t.title }),
                ],
              }),
              (0, j.jsxs)(`div`, {
                          ...
                          (0, j.jsxs)(`p`, {
                            ...
                            children: [
                              ...
                              (0, j.jsxs)(`span`, {
                                ...
                                children: [`(`, t.rating?.count, ` reviews)`],
                              }),
                            ],
                          }),
                          (0, j.jsxs)(`p`, {
...
var Rr = () => {
  let e = ct(),
    ...
    [a, o] = (0, x.useState)(``),
    [s, c] = (0, x.useState)([]),
    l = [`electronics`, `jewelery`, `men's clothing`, `women's clothing`],
    u = (e) => {
  ...
  return (0, j.jsxs)(`section`, {
    ...
    children: [
      (0, j.jsx)(`h1`, { children: `Let's add a new products` }),
      (0, j.jsxs)(`form`, {
        ...
        onSubmit: async (n) => {
          if (
            ...
            i(!0),
            o(``),
            !t.image || !t.category || !t.title || !t.price || !t.description)
          ) {
            (o(`All fields are required.`), i(!1));
            return;
          }
          try {
            (await Dr({
        ...
        children: [
          ...
          a &&
            (0, j.jsx)(`p`, {
              className: `add-product__form__error`,
              children: a,
            }),
          (0, j.jsxs)(`div`, {
            className: `add-product__form__btngroup`,
            children: [
              (0, j.jsx)(`button`, {
                type: `submit`,
                disabled: r,
                className: `add-product__form__btngroup__btn`,
                children: r ? `Saving...` : `Add Product`,
              }),
              (0, j.jsx)(`button`, {
                className: `add-product__form__btngroup__btn`,
                children: (0, j.jsx)(Tn, {
    ...
    children: (0, j.jsx)(Sn, {
      children: (0, j.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, j.jsx)(`main`, {
            className: `app-main`,
            children: (0, j.jsxs)(Ft, {
              children: [
                (0, j.jsx)(Nt, { path: `/`, element: (0, j.jsx)(Fr, {}) }),
                (0, j.jsx)(Nt, {
                  path: `/product/:id`,
                  element: (0, j.jsx)(Lr, {}),
                }),
                ...
                (0, j.jsx)(Nt, { path: `*`, element: (0, j.jsx)(zr, {}) }),
              ],
            }),
          }),
          (0, j.jsx)(yr, {}),
...
(0, Gn.createRoot)(document.getElementById(`root`)).render(
  (0, j.jsx)(x.StrictMode, { children: (0, j.jsx)(Br, {}) }),
);
